...
<body>
    ...
    <section>
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="./img/4.JPG" class="d-block w-100 min-vh-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./img/5.JPG" class="d-block w-100 min-vh-100" alt="...">
                </div>
            </div>
    ...
    <!-- <section id="hero">
        <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
            <h1 class="mb-4 pb-0">Minera<br><span>Shouxin</span> Perú S.A.</h1>
            <p class="mb-4 pb-0">Pagina en Construcción</p>
            <p class="mb-4 pb-0">2022, Ica, Nazca, Marcona</p>
            <a href="https://www.youtube.com/watch?v=wc0Z-L9i3t0" class="glightbox play-btn mb-4"></a>
        </div>
    </section> -->
    <!-- End Hero Section -->
