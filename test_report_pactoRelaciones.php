...
class PDF extends PDF_Rotate
{
    ...
    function Header()
    {
        ...
        $this->Cell(80);
        // Título
        $this->Cell(30, 10, utf8_decode('Cumplimiento de Pactos de Relaciónes Comunitarias'), 0, 0, 'C');
        // Salto de línea
        $this->Ln(20);
        //Put the watermark
...
$pdf->Cell(190, 5, utf8_decode('REGISTRO DE CUMPLIEMTO DE PACTOS DE RELACIÓNES COMUNITARIAS'), 0, 0);
$pdf->Ln();
$pdf->SetFont('Arial', '', 6);
