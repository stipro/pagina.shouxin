...
<body>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
      <h1 class="mb-4 pb-0">Minera<br><span>Shouxin</span> Peru S.A.</h1>
      <p class="mb-4 pb-0">Marcona, Nazca, Ica</p>
      <a href="https://youtu.be/wc0Z-L9i3t0" class="glightbox play-btn mb-4"></a>
      <a href="#about" class="about-btn scrollto">Sobre Minera Shouxin Peru S.A.</a>
    </div>
    ...
    <section id="about">
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-6">
            <h2>Sobre</h2>
            <p>Minera Shouxin Peru S.A. Nace en el 15/01/2011 como unión de dos compañías mineras SHOUGANG HIERRO PERU S.A.A.
              con el 49% de acciones y BAIYIN NONFERROUSE GROUP Co Ltd. Con el 51% de acciones, para el desarrollo
              de proyectos mineros.</p>
          </div>
          <div class="col-lg-6">
            <h3>Actualmente</h3>
            <p>distrito de Marcona, provincia de Nazca, departamento de Ica</p>
          </div>
          <!-- <div class="col-lg-3">
            <h3>When</h3>
